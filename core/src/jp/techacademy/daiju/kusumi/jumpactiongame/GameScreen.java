...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.daiju.kusumi.jumpactiongame"); // ←追加する
        mHighScore = mPrefs.getInteger("HIGHSCORE", 0); // ←追加する

        //音データを取り込む
        sound = Gdx.audio.newSound(Gdx.files.internal("crash_sound.mp3"));
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.7f) {
                Enemy enemy = new Enemy(enemyTexture, 0, 0, 171, 144);
